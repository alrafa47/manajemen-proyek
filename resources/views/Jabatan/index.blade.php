...
<div class="card">
    ...
    <div class="card-body">
        ...
        @endif
        <form action="{{ route('jabatan.store') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                        ...
                        <td>
                            <div class="btn-group">
                                <div class="d-flex">
                                    ...
                                    <a class="btn btn-warning" href={{route('jabatan.edit', ['id'=>$row->id])}}>ubah
                                    </a>
                                </div>
                            </div>
                        </td>
