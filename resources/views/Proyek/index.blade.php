    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @if (Auth::user()->role == 'admin')
                <form action="{{ route('proyek.store') }}" method="post" accept-charset="utf-8"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <div class="d-flex">
                                        @if (Auth::user()->role == 'admin')
                                            <form action={{ route('proyek.destroy', ['id' => $row->id]) }}
                                                method="POST">
                                                @csrf
                                                @method('delete')
                                            ...
                                            <a class="btn btn-warning"
                                                href={{ route('proyek.edit', ['id' => $row->id]) }}>ubah
                                            </a>
                                            <a class="btn btn-primary"
                                                href={{ route('proyek.show', ['id' => $row->id]) }}>Detail
                                            </a>
                                        @endif
                                        @if (Auth::user()->userable_id == $row->pegawai_id)
                                            <div class="btn-group">
                                                <div class="d-flex">
                                                    <a class="btn btn-primary"
                                                        href={{ route('tugas.create', ['proyek_id' => $row->id]) }}>
                                                        Penugasan </a>
                                                </div>
                                            </div>
                                        @endif
